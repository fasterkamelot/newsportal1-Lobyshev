	...
	public function registerUser() {
		...
		if(isset($_POST['save'])) {
			...
			if (!$password || !$confirm || mb_strlen($password) < 6) {
				...
				$errorString.="Пароль должен быть длиннее 6 символов<br />";
			...
			if (mb_strlen($errorString) == 0) {
				...
				$sql = "INSERT INTO `users` (`id`, `username`, `email`, `password`, `stauts`, `registration_date`, `pass`) VALUES (NULL, '$name', '$email', '$passwordHash', 'user', '$date', '$password')";
				$db = new Database();
